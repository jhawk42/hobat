...
export const FIELD_ALIASES = Object.freeze({
  ...
  eui64:                ["EUI64"],
  ipv6_addrs:           ["ipv6Addresses", "addrs", "addresses"],
  route:                ["route", "route64"],
...
export const EDGE_LQ_STYLES = Object.freeze({
  high: { width: 12, color: PALETTE.lqHigh, dashes: false, lqLevel: 3 }, // LQ3 bold blue  (.lq-high)
...
//
// Canonical mapping for #device-details section <ul> elements.
// sectionId must match an existing <ul id="..."> in tdash.html.
// fields preserves display order used by the details renderer.
// "*" is a wildcard sentinel (used by details-list).
// Headings remain in HTML by design.
export const DEVICE_DETAILS_SECTIONS = Object.freeze([
  {
    sectionId: "identity-list",
    fields: [
      "rloc16",
      "extAddress",
      "deviceLabel",
  ...
  },
  {
    ...
    fields: [
      ...
      "room",
      "icon",
      "graph.graphLinkCount",
      "graph.isRouter",
      "graph.isBorderRouter",
      "graph.hasChildren",
    ],
  },
  {
    sectionId: "network-list",
    fields: ["peerAddress", "ipv6Addresses", "serviceInfo.addressesParsed"],
  },
  {
    sectionId: "connections-list",
    fields: [
      "totalChildren",
      "hasChildren",
      "totalLinks",
  ...
  },
  {
    ...
    fields: [
      ...
      "matter.productId",
      "matter.productLabel",
      "matter.vendorSwVersion",
      "matter.vendorSwVersionNumber",
      "matter.vendorHwVersion",
      "matter.vendorHwVersionNumber",
      "matter.serialNumber",
      "matter.matterVersion",
      "matter.dataModelRevision",
      "matter.specificationVersion",
      "matter.location",
      "matter.manufacturingDate",
      "matter.partNumber",
      "matter.productUrl",
      "matter.localConfigDisabled",
      "matter.reachable",
      "matter.uniqueId",
      "matter.configurationVersion",
      "matter.available",
      "matter.isBridge",
      "matter.dateCommissioned",
      "matter.lastInterview",
      "matter.interviewVersion",
      "deviceTypes",
      "networkInterfaces",
      "generalDiagnostics",
    ],
  },
  {
    ...
    fields: [
      ...
      "serviceInfo.server",
      "serviceInfo.port",
      "serviceInfo.properties.mdns_scopes_thread",
      "serviceInfo.properties.mdns_scopes_br",
      "serviceInfo.properties.mdns_scopes_hap",
      "serviceInfo.properties.mdns_scopes_matter",
      "serviceInfo.properties.pt.fullName",
      "serviceInfo.properties.pt.intValue",
      "serviceInfo.properties.mn.fullName",
      "serviceInfo.properties.mn.decoded",
      "serviceInfo.properties.pv.fullName",
      "serviceInfo.properties.pv.decoded",
      "serviceInfo.properties.md.fullName",
      "serviceInfo.properties.md.decoded",
      "serviceInfo.properties.ci.fullName",
      "serviceInfo.properties.ci.categoryName",
      "serviceInfo.properties.ci.decoded",
      "serviceInfo.properties.ci.hex",
      "serviceInfo.properties.id.fullName",
      "serviceInfo.properties.id.decoded",
      "serviceInfo.properties.xa.fullName",
      "serviceInfo.properties.xa.hex",
      "serviceInfo.properties.vn.fullName",
      "serviceInfo.properties.vn.decoded",
      "serviceInfo.properties.tv.fullName",
      "serviceInfo.properties.tv.decoded",
      "serviceInfo.properties.rv.fullName",
      "serviceInfo.properties.rv.decoded",
      "serviceInfo.properties.nn.fullName",
      "serviceInfo.properties.nn.decoded",
      "serviceInfo.properties.xp.fullName",
      "serviceInfo.properties.xp.hex",
      "serviceInfo.properties.bb.fullName",
      "serviceInfo.properties.bb.hex",
      "serviceInfo.properties.sb.fullName",
      "serviceInfo.properties.sb.hex",
      "serviceInfo.properties.sf.fullName",
      "serviceInfo.properties.sf.hex",
      "serviceInfo.properties.sh.fullName",
      "serviceInfo.properties.sh.hex",
      "serviceInfo.properties.s#.fullName",
      "serviceInfo.properties.s#.decoded",
      "serviceInfo.properties.s#.hex",
      "serviceInfo.properties.c#.fullName",
      "serviceInfo.properties.c#.decoded",
      "serviceInfo.properties.c#.hex",
      "serviceInfo.properties.ff.fullName",
      "serviceInfo.properties.ff.decoded",
      "serviceInfo.properties.ff.hex",
      "serviceInfo.properties.FabricID_compressed.fullName",
      "serviceInfo.properties.FabricID_compressed.decoded",
      "serviceInfo.decoded_properties.SAI",
      "serviceInfo.decoded_properties.SAT",
      "serviceInfo.decoded_properties.SII",
      "serviceInfo.properties.NodeID.fullName",
      "serviceInfo.properties.NodeID.decoded",
      "serviceInfo.properties.SAI.fullName",
      "serviceInfo.properties.SAI.milliseconds",
      "serviceInfo.properties.SAT.fullName",
      "serviceInfo.properties.SAT.milliseconds",
      "serviceInfo.properties.SII.fullName",
      "serviceInfo.properties.SII.milliseconds",
    ],
  },
  {
    sectionId: "routes-links-list",
    fields: [
      "routes",
      "route",
      "route.routeData",
  ...
  {
    sectionId: "neighbors-list",
    fields: ["routerNeighbors"],
  },
  {
    sectionId: "children-list",
    fields: ["children", "childTable", "childIpv6Addresses"],
  },
  {
    sectionId: "counters-list",
    fields: [
      "macCounters.ifTotalPkts",
      "macCounters.ifTotalDiscards",
      "macCounters.ifTotalErrors",
      ...
      "mleCounters.totalParentPartitionChangesCount",
      "mleCounters.attachAttemptCount",
      "mleCounters.attachAttemptsCount",
      "mleCounters.detachedRoleCount",
      "mleCounters.radioDisabledCount",
      "mleCounters.childRoleTime",
      "mleCounters.detachedRoleTime",
      "mleCounters.leaderRoleTime",
      "mleCounters.radioDisabledTime",
      "mleCounters.routerRoleTime",
      "mleCounters.totalTrackingTime",
      "timeStatistics.leaderPct",
      "timeStatistics.routerPct",
      "timeStatistics.childPct",
      "timeStatistics.detachedDisabledPct",
      "timeStatistics.detachedPct",
      "timeStatistics.disabledPct",
    ],
  },
  {
    sectionId: "details-list",
    fields: ["*"],
  },
]);
